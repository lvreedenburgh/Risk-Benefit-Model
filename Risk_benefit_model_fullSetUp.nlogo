...
to setupconsumers
  ...
  ask consumers [set leader? 0]
  ask n-of (consumer_leaders * No_consumers) consumers with [leader? = 0] [set leader? true set size 5]

  set agentset consumers with [leader? = 0]
  ask agentset [setupnetworks]

  set agentset farmers with [leader? = 1]
  ;ask agentset [setupnetworks]
...
to setupfarmers
  ...
  ask farmers [set leader? 0]
  ask n-of (farmer_leaders * No_farmers) farmers with [leader? = 0] [set leader? true set size 5]

  set agentset farmers with [leader? = 0]
  ask agentset [setupnetworks]
...
to con-leaders-pick
  ...
  ask consumers with [leader? = true]
  [
    change-R-and-B
